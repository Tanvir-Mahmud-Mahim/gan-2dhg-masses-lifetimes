...
R_L_RANGE = (MU_HALL_L / (MU_Q_L + MU_Q_L_ERR),
             MU_HALL_L / (MU_Q_L - MU_Q_L_ERR))            # 4.97 to 5.37
R_H_RANGE = (MU_HALL_H / MU_Q_H_RANGE[1],
             MU_HALL_H / MU_Q_H_RANGE[0])                  # 2.00 to 2.40
R_H = 0.5 * (R_H_RANGE[0] + R_H_RANGE[1])                  # 2.20
R_L_LOW = R_L_RANGE[0] * M_L_ZERO_FIELD / M_L              # 2.81
